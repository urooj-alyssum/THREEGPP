...
import ssl
ssl._create_default_https_context = ssl._create_unverified_context  # Bypass SSL verification for NLTK
load_dotenv()
...
def loader_func():
    ...
    """
    loader = LangchainPineconeLoader(bucket_name="datacrux-dev", directory_path="3gpp/Testing/", index_name="testing")
